...
namespace FONTS
{
	...
	unsigned int font_dmg_indicator;
	...
	void InitFonts()
	{
		...
		//verdana 25 500
		visuals_lby_font = RENDER::CreateF("Arial", 30, 750, 0, 0, SDK::FONTFLAG_ANTIALIAS | SDK::FONTFLAG_OUTLINE);
		font_weapon_icon = RENDER::CreateF("astriumwep", 16, 400, 0, 0, SDK::FONTFLAG_DROPSHADOW | SDK::FONTFLAG_ANTIALIAS);
		font_dmg_indicator = RENDER::CreateF("Smallest Pixel-7", 16, 200, 0, 0, SDK::FONTFLAG_OUTLINE | SDK::FONTFLAG_ANTIALIAS);
	}
}
namespace SETTINGS
{
